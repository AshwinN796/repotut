        ...
        return if (response.isSuccessful) {
            if (body != null) {
                ...
                if (successBodyType == Unit::class.java) {
                    ...
                    NetworkResponse.Success(Unit) as NetworkResponse<S>
                } else {
            ...
            val networkResponse: NetworkResponse<S> = try {
...
//                    val event: ErrorBody? = adapter.fromJson(errorBody.charStream().toString())
//                    event
                    null
                }
